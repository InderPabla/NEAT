...
public class Agent : MonoBehaviour {
    ...
    private void UpdateNet() {
        ...
        float abs = Mathf.Abs(bodies[0].transform.position.x);
        float[] inputValues = {boardVelocity, abs, pole1AngleRadian, pole2AngleRadian, pole1AngularVelocity, pole2AngularVelocity}; //gather pole and track data into an array 
