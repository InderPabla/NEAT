...
public class Species
{
    ...
    NEATGeneticControllerV2 manager; //manager that controls all, the god, the great, the best, ME
    ...
    public void GenerateNewGeneration(int maxCap)
    {
        ...
        for (int i = 0; i < species.Count; i++)
        {
            ...
            species[i].RemoveWorst(manager.remoteWorst);
        }
